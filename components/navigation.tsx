          ...
          <div className="md:hidden py-4 border-t border-border">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3 pt-4 mt-2 border-t border-border">
                <a href="https://api.whatsapp.com/send?phone=9334812901" target="_blank" rel="noopener noreferrer" className="flex-1">
                  <Button className="w-full h-12 bg-[#25D366] hover:bg-[#1da851] text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all">
                ...
                <a href="tel:9334812901" className="flex-1">
                  <Button className="w-full h-12 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-semibold rounded-xl shadow-md hover:shadow-lg hover:opacity-90 transition-all">
